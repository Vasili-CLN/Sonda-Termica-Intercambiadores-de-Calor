//Se utilizo este proyecto para probar multimes BME280, y se conservo toda la documentación original
/***************************************************************************
...
void setup() {
  ...
  //Connect the Chip Select pins from the sensors to regular digital pins on the Arduino.
    ...
    bme4.parameter.SPI_cs = 4;                          //Chip Select Pin for Sensor 4
  ...
  //You may change those pins if you like, but remember to connect that pin to all sensors.
    ...
    bme4.parameter.SPI_miso = 11;                       //The MISO/SDO signal must be connected to the same pin for all sensors
    ...
    bme4.parameter.SPI_sck = 12;                       //The SCK/SCL signal must be connected to the same pin for all sensors    
